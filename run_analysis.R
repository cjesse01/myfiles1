...
## autogenerated directories with unzip:
# ./UCI HAR Dataset
...
## create a "positional vector" for the 66 columns (feature mean/std) to be extracted
        # NOTES:
        # time domain feature mean() and std() are in ( position <=254 )
        # frequency domain feature mean() and std() are in (266 <= position <= 543)
...
?xtabs #in stats package, frequency counts
